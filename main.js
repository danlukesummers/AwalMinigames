/* AWAL Minigames -- shared across every page: nav dropdown, FAQ/pricing/login/terms
  ...
  const GAME_LIBRARY = [
    ...
    { id:'word-association', name:'Word Association', short:'Word Chain', icon:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="12" r="3.2"/><circle cx="17" cy="12" r="3.2"/><path d="M10.2 12h3.6"/></svg>', tint:'#EAFBD0', accent:'#6FB800', tagline:'Keep the word chain alive, one association at a time.', status:'beta', onClick:"window.location.href='word-association.html';" },
